...
// function doSub() {
//     /****
//      * new FormData()的另外一种赋值方式，直接获取页面中的form节点
//      */
//     var data = new FormData(document.querySelector('form'));
//     //data.append('userName',document.getElementById('userName').value); ////用户名
//     //data.append('pwd',document.getElementById('pwd').value);  ////密码
//     //data.append('nickName',document.getElementById('nickName').value); /////昵称
...
//             else {
//                 ////实现页面跳转
//                 //window.location.href = '/comment.html?userName='+res.userName
//                 window.location.href = '/list.html';
//             }
//         }
//     }
